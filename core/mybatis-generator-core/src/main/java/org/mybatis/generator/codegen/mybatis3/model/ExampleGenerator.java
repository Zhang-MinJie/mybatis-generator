...
public class ExampleGenerator extends AbstractJavaGenerator {
	...
	private InnerClass getGeneratedCriteriaInnerClass(TopLevelClass topLevelClass) {
		...
		for (IntrospectedColumn introspectedColumn : introspectedTable.getNonBLOBColumns()) {
			...
			answer.addMethod(getSetEqualMethodIgnoreNull(introspectedColumn));

			answer.addMethod(getSetNotEqualMethod(introspectedColumn));
			answer.addMethod(getSetNotEqualMethodIgnoreNull(introspectedColumn));

			answer.addMethod(getSetGreaterThanMethod(introspectedColumn));
			answer.addMethod(getSetGreaterThanMethodIgnoreNull(introspectedColumn));

			answer.addMethod(getSetGreaterThenOrEqualMethod(introspectedColumn));
			answer.addMethod(getSetGreaterThenOrEqualMethodIgnoreNull(introspectedColumn));

			answer.addMethod(getSetLessThanMethod(introspectedColumn));
			answer.addMethod(getSetLessThanMethodIgnoreNull(introspectedColumn));

			answer.addMethod(getSetLessThanOrEqualMethod(introspectedColumn));
			answer.addMethod(getSetLessThanOrEqualMethodIgnoreNull(introspectedColumn));

			if (introspectedColumn.isJdbcCharacterColumn()) {
				answer.addMethod(getSetLikeMethod(introspectedColumn));
				answer.addMethod(getSetLikeMethodIgnoreNull(introspectedColumn));

				answer.addMethod(getSetNotLikeMethod(introspectedColumn));
				answer.addMethod(getSetNotLikeMethodIgnoreNull(introspectedColumn));
			}
	...
	private Method getSetEqualMethodIgnoreNull(IntrospectedColumn introspectedColumn) {
		return getSingleValueMethod(introspectedColumn, "EqualToIgnoreNull", "=", true); //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	private Method getSetNotEqualMethodIgnoreNull(IntrospectedColumn introspectedColumn) {
		return getSingleValueMethod(introspectedColumn, "NotEqualToIgnoreNull", "<>", true); //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	private Method getSetGreaterThanMethodIgnoreNull(IntrospectedColumn introspectedColumn) {
		return getSingleValueMethod(introspectedColumn, "GreaterThanIgnoreNull", ">", true); //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	private Method getSetGreaterThenOrEqualMethodIgnoreNull(IntrospectedColumn introspectedColumn) {
		return getSingleValueMethod(introspectedColumn, "GreaterThanOrEqualToIgnoreNull", ">=", true); //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	private Method getSetLessThanMethodIgnoreNull(IntrospectedColumn introspectedColumn) {
		return getSingleValueMethod(introspectedColumn, "LessThanIgnoreNull", "<", true); //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	private Method getSetLessThanOrEqualMethodIgnoreNull(IntrospectedColumn introspectedColumn) {
		return getSingleValueMethod(introspectedColumn, "LessThanOrEqualToIgnoreNull", "<=", true); //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	private Method getSetLikeMethodIgnoreNull(IntrospectedColumn introspectedColumn) {
		return getSingleValueMethod(introspectedColumn, "LikeIgnoreNull", "like", true); //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	private Method getSetNotLikeMethodIgnoreNull(IntrospectedColumn introspectedColumn) {
		return getSingleValueMethod(introspectedColumn, "NotLikeIgnoreNull", "not like", true); //$NON-NLS-1$ //$NON-NLS-2$
	}

	private Method getSingleValueMethod(IntrospectedColumn introspectedColumn, String nameFragment, String operator) {
		return this.getSingleValueMethod(introspectedColumn, nameFragment, operator, false);
	}
	...
	private Method getSetInOrNotInMethod(IntrospectedColumn introspectedColumn, boolean inMethod) {
		return getSetInOrNotInMethod(introspectedColumn, inMethod, false);
	}
	...
	private Method getSetInOrNotInMethod(IntrospectedColumn introspectedColumn, boolean inMethod,
		...
		if (inMethod) {
			if (isIgnoreNull) {
				sb.append("InIgnoreNull"); //$NON-NLS-1$
			} else {
				sb.append("In"); //$NON-NLS-1$
			}
		} else {
			if (isIgnoreNull) {
				sb.append("NotInIgnoreNull"); //$NON-NLS-1$
			} else {
